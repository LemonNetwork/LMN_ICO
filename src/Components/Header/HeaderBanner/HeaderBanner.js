...
const HeaderBanner = ({ quantity, setQuantity }) => {
  ...
  const analPhase = () => {
    if (phase === "PRE ICO") {
      return "starts in:";
    } else if (phase === "ICO PHASE 1") {
      return "Phase 1, ends in:";
                  ...
                  <ul className="cpn-links flex-wrap flex-sm-nowrap cpn-links-s1 pt-0 pb-3 pb-sm-0">
                    ...
                    <li className="order-sm-0 order-last w-100">
                      {phase === "ICO ENDED" ? (
                        ...
                        <a className="btn btn-round btn-primary btn-lg gradient-banner-btn">
                          Buy LMN
                        </a>
                      ) : (
                        <a
